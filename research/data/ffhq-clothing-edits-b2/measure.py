...
for index, row in enumerate(prompts['records']):
    ...
    entries.append({'id': row['id'], 'training_eligible': False, 'source_rgb': raw,
                    ...
                    'collar_complete_in_frame': row['id'] != '051',
                    'collar_review': ('White Roman tab visible; lower edge cut by frame' if row['id'] == '051' else 'Recognizable white Roman tab completely visible below chin')})
