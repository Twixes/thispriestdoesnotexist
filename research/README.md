...
No model has passed the visual quality requirement or been deployed. The full reference trainer's preserved step-500 checkpoint has seen 32,000 image presentations. Its [unfiltered 32-seed review](reviews/reference500-unseen32-visual-review.json) found seven severe head/face failures, despite 29 recognizable clerical shirts/tabs. The [guarded 500-to-625 continuation](experiments/reference_resume500_625/README.md) has now started with unchanged 110-image inputs and recipe in [a separate run](runs/reference256-paper-b64-resumed500-to625/). Its initial raw/EMA/truncated previews are byte-identical to the archived step-500 previews. The launch and completion records establish its current execution state; it is not an automatic continuation to one million presentations.
