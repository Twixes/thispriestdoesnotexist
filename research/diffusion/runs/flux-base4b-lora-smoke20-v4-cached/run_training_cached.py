...
def parse_args(input_args=None):
    ...
    parser.add_argument("--priest_cached_data", type=Path, required=True,
...
def main(args):
    ...
    smoke.resources(smoke_state, "transformer_loaded_cpu", 0)
