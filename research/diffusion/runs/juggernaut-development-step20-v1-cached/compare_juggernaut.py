...
promising1024 run. Optional UNet-only LoRA and staged cached conditioning retain
all outputs; no retries, repairs or selected output.
"""
import argparse
import gc
import hashlib
...
COMPONENTS = HERE / "models/juggernaut-x-hyper-components"
COMPONENT_PROVENANCE_SHA256 = "8e1c607e04bef6fcee8e778e9e4fc5d163ae19f29d67d80149debd61ad78774d"
...
def worker(args):
    ...
    from diffusers import StableDiffusionXLPipeline, TCDScheduler, UNet2DConditionModel, AutoencoderKL
    ...
    if protocol["cached_text"]:
        ...
        pipe = StableDiffusionXLPipeline(**encoders, unet=None, vae=None,
            ...
            scheduler=TCDScheduler.from_config(json.loads((COMPONENTS / "scheduler/scheduler_config.json").read_text())),
