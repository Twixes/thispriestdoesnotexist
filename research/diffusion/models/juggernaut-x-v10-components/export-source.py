...
SOURCE = HERE / "models/juggernaut-x-v10"
DESTINATION = HERE / "models/juggernaut-x-v10-components"
REVISION = "35e4f3ccbe745c3e1221715d04a452aaa1ee5761"
CHECKPOINT_SHA = "d91d35736d8f2be038f760a9b0009a771ecf0a417e9b38c244a84ea4cb9c0c45"
SOURCE_PROVENANCE_SHA = "154d5e4735df58e6af795657e19a436b540dafdd1d6cb34374ab03befce64e70"
GIB = 1024 ** 3
BUFFER = 8 * 1024 ** 2
DEADLINE = 1200
...
def worker(output):
    ...
    write(output / "provenance.json", {"complete": True, "model": "RunDiffusion/Juggernaut-X-v10",
