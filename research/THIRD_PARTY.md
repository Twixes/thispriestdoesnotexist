...
- `models/ffhq256.pkl`, `models/ffhq1024.pkl`, and derived checkpoints: NVIDIA FFHQ StyleGAN2 research weights and derivatives, subject to that upstream license. The personal site is a noncommercial generative-model research demonstration. A commercial deployment or redistribution under MIT would require a separately licensed model.
